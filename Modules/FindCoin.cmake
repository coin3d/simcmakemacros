...
IF(NOT COINDIR)
  ...
  IF(COINDIR)
    MESSAGE(STATUS "Setting COINDIR from environment variable")
  ENDIF(COINDIR)
ENDIF(NOT COINDIR)
...
IF (Coin_FOUND AND WIN32)
  ...
  ELSE()
    ...
    ELSE(COIN_NOT_DLL)
      SET(Coin_DEFINES -DCOIN_DLL)
      MESSAGE(STATUS "WARNING: Could not find Coin.pc, using -DCOIN_DLL. Override with cmake -DCOIN_NOT_DLL")
    ENDIF(COIN_NOT_DLL)
  ENDIF()
ENDIF()
